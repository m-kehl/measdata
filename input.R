...
meteo_parameters <- data.frame(parameter = c("Temperatur","Niederschlag",
                                             ...
                                             "Globalstrahlung","Sonnenscheindauer (pro 10min)"),
                               unit = c("\u00B0C", "mm", "%", "h","hPa",
                                        "\u00B0C","\u00B0C","min",
                               ...
                               mch_name_daily = c("tre200d0","rre150d0","ure200d0","sre000d0","prestad0",
                                                  "tre005d0","XX","XX","fkl010d0","fkl010d1","htoautd0",
                                                  "XX","pva200d0","tre200dx","tre200dn","XX",
                                                  "gre000d0","XX"),
